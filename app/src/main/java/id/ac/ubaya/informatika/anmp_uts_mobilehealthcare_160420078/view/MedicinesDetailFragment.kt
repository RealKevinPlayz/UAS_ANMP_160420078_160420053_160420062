...
class MedicinesDetailFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        dataBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_medicines_detail, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        var id = MedicinesDetailFragmentArgs.fromBundle(requireArguments()).id.toInt()
        viewModel.fetch(id)
        observeViewModel()
        /*
        if(arguments != null) {
