...
class PharmacyDetailViewModel : ViewModel() {
    ...
    fun fetch(pharmacyName:String, pharmacyOpeningHour:String, pharmacyAddress:String,
              pharmacyPhone:String, pharmacyPhotoUrl:String, pharmacyRating:String) {
        val pharmacyData = Pharmacy(pharmacyName, pharmacyOpeningHour, pharmacyAddress, pharmacyPhone,
