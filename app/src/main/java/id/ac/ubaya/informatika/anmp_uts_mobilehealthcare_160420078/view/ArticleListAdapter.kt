...
class ArticleListAdapter(var articleList:ArrayList<Article>, var adapterOnClick : (Article) -> Unit) : RecyclerView.Adapter<ArticleListAdapter.ArticleViewHolder>(), ArticleLayoutInterface {
