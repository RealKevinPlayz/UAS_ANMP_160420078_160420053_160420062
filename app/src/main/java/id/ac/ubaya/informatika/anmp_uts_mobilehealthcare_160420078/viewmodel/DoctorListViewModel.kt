...
class DoctorListViewModel(application: Application): AndroidViewModel(application), CoroutineScope{
    var doctorLD = MutableLiveData<List<Doctor>>()
    var doctorLoadErrorLD = MutableLiveData<Boolean>()
    ...
    fun refreshDoctor() {
        ...
        /*
        val doctorsJson = "[{'doctorName' : 'dr. Prettysun Ang Mellow, Sp.PD'," +
                ...
                "'doctorRating' : '5'},{'doctorName' : 'dr. Andry Sultana, Sp.PD, FINASIM','doctorSpecialty' : 'Dokter Penyakit Dalam'," +
                ...
                "'doctorRating' : '4'},{'doctorName' : 'dr. Dimple Gobind Nagrani, Sp.A','doctorSpecialty' : 'Dokter Anak'," +
                ...
                "'doctorRating' : '4'}, {'doctorName' : 'dr. Bambang Herwanto, Sp.JP, FIHA'," +
                ...
                "'doctorRating' : '5'},{'doctorName' : 'dr. Ivana Sugiarto, M.Biomed, Sp.KK','doctorSpecialty' : 'Dokter Kulit'," +
                ...
                "'doctorRating' : '4'},{'doctorName' : 'dr. Jose Laksmana Anggowarsito, G.Dimp. Derm, Sp.KK','doctorSpecialty' : 'Dokter Kulit'," +
                ...
                "'doctorRating' : '4'},{'doctorName' : 'dr. Moch. Wachid, Sp.THT-KL','doctorSpecialty' : 'Dokter THT'," +
                ...
                "'doctorRating' : '4'},{'doctorName' : 'dr. Chandra Irwanadi Mohani, Sp.PD, KGH' , 'doctorSpecialty' : 'Dokter Ginjal'," +
    ...
    fun clearTaskDoctor(doctor: Doctor){
        launch {
            var db = buildDoctorDB(getApplication())
        }
    }
