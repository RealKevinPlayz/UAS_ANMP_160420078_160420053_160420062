...
class PharmacyListAdapter(var pharmacyList:ArrayList<Pharmacy>, var adapterOnClick : (Pharmacy) -> Unit) : RecyclerView.Adapter<PharmacyListAdapter.PharmacyViewHolder>(), PharmacyLayoutInterface {
    ...
    override fun onBindViewHolder(holder: PharmacyViewHolder, position: Int) {
        ...
        var hospitalProgressBar = holder.view.findViewById<ProgressBar>(R.id.pharmacyCardProgressBar)
        imageView.loadImage(pharmacyList[position].pharmacyPhotoUrl, hospitalProgressBar)
    ...
    override fun onButtonDetailPharmacyClick(v: View) {
        var id = v.tag.toString()
        //var action = PharmacyListFragmentDirections.actionPharmacyDetail(id)
