...
class PharmacyDetailFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        dataBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_pharmacy_detail, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        var id = PharmacyDetailFragmentArgs.fromBundle(requireArguments()).id.toInt()
        viewModel.fetch(id)
        observeViewModel()
        /*
        if(arguments != null) {
